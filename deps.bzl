##
## This file was auto-generated by running:
...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:M21Uhqx97uKzB9NhtPxUGT1EzP/AkLaVHD5vib+qoK4=",
        version = "v0.42.0",
    )
    go_repository(
        ...
        sum = "h1:0vzgiFDsCh/jxRCR1xcRrtMoeCu2itXz/PsXst5P8rI=",
        version = "v0.42.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IX8d7l2uRw61BlmZBOTQFaK+y22j6vytMVTs9wFrO+c=",
        version = "v1.17.0",
    )
    go_repository(
